...
#define HLCD_DATA_PIN0_PORTX		DIO_PORTD
#define HLCD_DATA_PIN0_PINX			DIO_PIN0
#define HLCD_DATA_PIN1_PORTX		DIO_PORTD
#define HLCD_DATA_PIN1_PINX			DIO_PIN1
#define HLCD_DATA_PIN2_PORTX		DIO_PORTD
#define HLCD_DATA_PIN2_PINX			DIO_PIN2
#define HLCD_DATA_PIN3_PORTX		DIO_PORTD
...
/*		#define HLCD_DATA_PORT		PORTD							*/
#define HLCD_DATA_PIN4_PORTX		DIO_PORTD
#define HLCD_DATA_PIN4_PINX			DIO_PIN4
#define HLCD_DATA_PIN5_PORTX		DIO_PORTD
#define HLCD_DATA_PIN5_PINX			DIO_PIN5
#define HLCD_DATA_PIN6_PORTX		DIO_PORTD
#define HLCD_DATA_PIN6_PINX			DIO_PIN6
#define HLCD_DATA_PIN7_PORTX		DIO_PORTD
